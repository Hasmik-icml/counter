...
document.querySelector(".fibonachiButtons").addEventListener("click", function () {
    ...
    function fib() {
        document.querySelector(".resultFibonachi").innerHTML += "," + fibonachiNumbers[fibonachiNumbers.length - 1] + fibonachiNumbers[fibonachiNumbers.length - 2];
        fibonachiNumbers.push(fib());
