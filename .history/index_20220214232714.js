...
document.querySelector(".fibonachiButtons").addEventListener("click",function(){
  ...
  let res =  fib(next);
  console.log(res);
  document.querySelector(".resultFibonachi").innerHTML = res;
  
})


function fib(next){
   return fibonachiNumbers.push(fibonachiNumbers[fibonachiNumbers.length] + fibonachiNumbers[fibonachiNumbers.length - 1]);
}