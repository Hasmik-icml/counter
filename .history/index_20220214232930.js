...
document.querySelector(".fibonachiButtons").addEventListener("click",function(){
  ...
  console.log(res);
  console.log(next);
  document.querySelector(".resultFibonachi").innerHTML = res[next];
...
function fib(next){
    console.log(next)
    fibonachiNumbers.push(fibonachiNumbers[fibonachiNumbers.length] + fibonachiNumbers[fibonachiNumbers.length - 1]);
